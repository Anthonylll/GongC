...
public abstract class Request<T> implements Comparable<Request<T>> {
	/** 2分钟缓存时间 */
	public static final long CONFIG_CACHE_SHORT = 60 * 2; // 单位 秒

	/** 5分钟缓存时间 */
	public static final long CONFIG_CACHE_MEDIUM = 60 * 5; // 单位 秒

	/** 2小时缓存时间 */
	public static final long CONFIG_CACHE_ML = 3600 * 2; // 单位 秒

	/** 1天缓存时间 */
	public static final long CONFIG_CACHE_MAX = 60 * 60 * 24 * 1; // 单位 秒

	public long mCacheTime = CONFIG_CACHE_MEDIUM;
	/**
	 ...
	 *         {@link android.net.TrafficStats#setThreadStatsTag(int)}
	 */
	...
	/**
	 * Returns the {@link com.android.volley.Request.Priority} of this request;
	 * {@link com.android.volley.Request.Priority#NORMAL} by default.
	 */

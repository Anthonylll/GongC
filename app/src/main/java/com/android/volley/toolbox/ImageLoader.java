 ...
 * {@link com.android.volley.toolbox.ImageLoader#get(String, com.android.volley.toolbox.ImageLoader.ImageListener)}
 * and to pass in the default image listener provided by
 * {@link com.android.volley.toolbox.ImageLoader#getImageListener(android.widget.ImageView, int, int)}
 * . Note that all function calls to this class must be made from the main
...
public class ImageLoader {
	 ...
	 * the loaded bitmap. If the default was returned, the
	 * {@link com.android.volley.toolbox.ImageLoader} will be invoked when the
	 ...
	 * {@link #get(String, com.android.volley.toolbox.ImageLoader.ImageListener, int, int, android.widget.ImageView.ScaleType)}
	 * with {@code Scaletype == ScaleType.CENTER_INSIDE}.
	 */

...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF0000000;// 黑色
	/** Items text color */
	// private static final int ITEMS_TEXT_COLOR = 0xFF000000;
	private static final int ITEMS_TEXT_COLOR = 0x80808080;// 灰色
	...
	/**
	 * 滚动的动画 Set the the specified scrolling interpolator
	 * 
	 * @param interpolator
	 *            the interpolator
	 */

...
public class SelectbjdcDialog extends Dialog implements OnClickListener {

	private final static String TAG = "SelectbjdcDialog";
	...
	private LinearLayout layout_sxds;// 上下单双布局
	private LinearLayout layout_sfgg;// 胜负过关布局
	...
	// 上下单双
	private LinearLayout layout_item701, layout_item702, layout_item703,
			layout_item704;
	private TextView tv_item701, tv_item702, tv_item703, tv_item704;// 赔率
	private TextView tv_701, tv_702, tv_703, tv_704;// 标签
	// 胜负过关
	private LinearLayout layout_item601, layout_item602;// 胜，负
	private TextView tv_601, tv_602;// 标签
	private TextView tv_item601, tv_item602;// 赔率
	// 比分
	...
	private DtMatchBJDC dm;// 比赛对阵

	private LinearLayout layout_rq;
	private TextView tv_rq;

	public SelectbjdcDialog(Context context, DtMatchBJDC dm) {
		super(context);
		this.dm = dm;
	}

	public SelectbjdcDialog(Context context, boolean cancelable,
			OnCancelListener cancelListener, DtMatchBJDC dm) {
		super(context, cancelable, cancelListener);
		this.dm = dm;
	}

	public SelectbjdcDialog(Context context, int theme, DtMatchBJDC dm) {
		super(context, theme);
		this.dm = dm;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.select_bjdc_dialog);
	...
	public void findView() {
		...
		layout_sxds = (LinearLayout) findViewById(R.id.layout_sxds);
		layout_sfgg = (LinearLayout) findViewById(R.id.layout_sfgg);
		...
		// 上下单双
		layout_item701 = (LinearLayout) findViewById(R.id.layout_item701);
		layout_item702 = (LinearLayout) findViewById(R.id.layout_item702);
		layout_item703 = (LinearLayout) findViewById(R.id.layout_item703);
		layout_item704 = (LinearLayout) findViewById(R.id.layout_item704);
		// 赔率
		tv_item701 = (TextView) findViewById(R.id.tv_item701);
		tv_item702 = (TextView) findViewById(R.id.tv_item702);
		tv_item703 = (TextView) findViewById(R.id.tv_item703);
		tv_item704 = (TextView) findViewById(R.id.tv_item704);
		tv_701 = (TextView) findViewById(R.id.tv_701);
		tv_702 = (TextView) findViewById(R.id.tv_702);
		tv_703 = (TextView) findViewById(R.id.tv_703);
		tv_704 = (TextView) findViewById(R.id.tv_704);

		// 胜负过关
		layout_item601 = (LinearLayout) findViewById(R.id.layout_item601);
		layout_item602 = (LinearLayout) findViewById(R.id.layout_item602);

		// 赔率
		tv_item601 = (TextView) findViewById(R.id.tv_item601);
		tv_item602 = (TextView) findViewById(R.id.tv_item602);

		tv_601 = (TextView) findViewById(R.id.tv_601);
		tv_602 = (TextView) findViewById(R.id.tv_602);
	...
	public void init() {
		...
		if (!dm.isSXDS()) {// 上下单双
			layout_sxds.setVisibility(View.GONE);
		}
		if (!dm.isSFGG()) {// 胜负过关
			layout_sfgg.setVisibility(View.GONE);
		}
		...
		Spanned text = Html.fromHtml(AppTools.changeStringColor("#808080",
				...
				+ AppTools.changeStringColor(color, ball + ""));
		...
		// 上下单双
		tv_item701.setText(dm.getUpdan());
		tv_item702.setText(dm.getUpshuang());
		tv_item703.setText(dm.getDowndan());
		tv_item704.setText(dm.getDownshuang());
		// 比分
		// 胜
	...
	public void setSelect(ArrayList<String> selectResult) {
		...
		// 大小单双
		setAllBackGround("701", layout_item701, tv_701, tv_item701);
		setAllBackGround("702", layout_item702, tv_702, tv_item702);
		setAllBackGround("703", layout_item703, tv_703, tv_item703);
		setAllBackGround("704", layout_item704, tv_704, tv_item704);

		// 胜负过关
		setAllBackGround("601", layout_item601, tv_601, tv_item601);
		setAllBackGround("602", layout_item602, tv_602, tv_item602);
		...
		setAllBackGround("310", layout_item313, tv_313, tv_item313);
		setAllBackGround("311", layout_item314, tv_314, tv_item314);
		setAllBackGround("312", layout_item315, tv_315, tv_item315);
		setAllBackGround("313", layout_item316, tv_316, tv_item316);
		setAllBackGround("314", layout_item317, tv_317, tv_item317);
		setAllBackGround("315", layout_item318, tv_318, tv_item318);
		setAllBackGround("316", layout_item319, tv_319, tv_item319);
		setAllBackGround("317", layout_item320, tv_320, tv_item320);
		setAllBackGround("318", layout_item321, tv_321, tv_item321);
		setAllBackGround("319", layout_item322, tv_322, tv_item322);
		setAllBackGround("320", layout_item323, tv_323, tv_item323);
		setAllBackGround("321", layout_item324, tv_324, tv_item324);
		setAllBackGround("322", layout_item325, tv_325, tv_item325);
		setAllBackGround("323", layout_item326, tv_326, tv_item326);
		setAllBackGround("324", layout_item327, tv_327, tv_item327);
		setAllBackGround("325", layout_item331, tv_331, tv_item331);
		// 总进球
	 ...
	 * @param visible
	 */
	public void setSxdsLayoutVisible(int visible) {
	 ...
	 * @param visible
	 */
	public void setSfggLayoutVisible(int visible) {
		layout_bifen.setVisibility(visible);
	}
	...
	private void setListner() {
		...
		// 上下过关
		layout_item701.setOnClickListener(this);
		layout_item702.setOnClickListener(this);
		layout_item703.setOnClickListener(this);
		layout_item704.setOnClickListener(this);

		// 胜负
		layout_item601.setOnClickListener(this);
		layout_item602.setOnClickListener(this);
		// 比分
	...
	public void onClick(View v) {
		...
		case R.id.layout_item103:
			...
			break;
		// 上下单双
		case R.id.layout_item701:
			addAndRemove("701", layout_item701, tv_701, tv_item701);
			break;
		case R.id.layout_item702:
			addAndRemove("702", layout_item702, tv_702, tv_item702);
			break;
		case R.id.layout_item703:
			addAndRemove("703", layout_item703, tv_703, tv_item703);
			break;
		case R.id.layout_item704:
			addAndRemove("704", layout_item704, tv_704, tv_item704);
			break;
		// 胜负过关
		case R.id.layout_item601:
			addAndRemove("601", layout_item601, tv_601, tv_item601);
			break;
		case R.id.layout_item602:
			addAndRemove("602", layout_item602, tv_602, tv_item602);
			break;
		...
		case R.id.layout_item313:
			addAndRemove("310", layout_item313, tv_313, tv_item313);
			break;
		case R.id.layout_item314:
			addAndRemove("311", layout_item314, tv_314, tv_item314);
			break;
		case R.id.layout_item315:
			addAndRemove("312", layout_item315, tv_315, tv_item315);
			break;
		case R.id.layout_item316:
			addAndRemove("313", layout_item316, tv_316, tv_item316);
			break;
		case R.id.layout_item317:
			addAndRemove("314", layout_item317, tv_317, tv_item317);
			break;
		case R.id.layout_item318:
			addAndRemove("315", layout_item318, tv_318, tv_item318);
			break;
		case R.id.layout_item319:
			addAndRemove("316", layout_item319, tv_319, tv_item319);
			break;
		case R.id.layout_item320:
			addAndRemove("317", layout_item320, tv_320, tv_item320);
			break;
		case R.id.layout_item321:
			addAndRemove("318", layout_item321, tv_321, tv_item321);
			break;
		case R.id.layout_item322:
			addAndRemove("319", layout_item322, tv_322, tv_item322);
			break;
		case R.id.layout_item323:
			addAndRemove("320", layout_item323, tv_323, tv_item323);
			break;
		case R.id.layout_item324:
			addAndRemove("321", layout_item324, tv_324, tv_item324);
			break;
		case R.id.layout_item325:
			addAndRemove("322", layout_item325, tv_325, tv_item325);
			break;
		case R.id.layout_item326:
			addAndRemove("323", layout_item326, tv_326, tv_item326);
			break;
		case R.id.layout_item327:
			addAndRemove("324", layout_item327, tv_327, tv_item327);
			break;
		case R.id.layout_item331:
			addAndRemove("325", layout_item331, tv_331, tv_item331);
			break;
	...
	public void addAndRemove(String content, LinearLayout layout, TextView tv,
		...
		if (selectResult.contains(content)) {// 包含则移除
			...
			setBackGround(layout, R.drawable.select_jczq_tv_bolder_lightpink,
					tv, R.color.black, tv_odds, R.color.gray);
		} else {// 不包含则添加

...
public class Select_sfc_hhtz_jclq_Dialog extends Dialog implements
	 ...
	 */
	public Select_sfc_hhtz_jclq_Dialog(Context context,
			CJLQMatchItemFragment fragment, int theme, int adapterType,
	...
	private void dateinit() {
		...
		if (type == 1) {
			...
			if (Double.parseDouble(LetScore.equals("")||LetScore.equals("null") ? "0" : LetScore) < 0)
	...
	private void showr_rsult() {
		...
		for (int i = 0; i < ll_view.length; i++) {
			ll_view[i]
					.setBackgroundResource(R.drawable.select_jczq_tv_bolder_lightpink);
	...
	public void getresult() {
		if (type == 0) {
			...
			System.out.println("====ExpandAdapter_jclq_52.map_hashMap_cbf=="

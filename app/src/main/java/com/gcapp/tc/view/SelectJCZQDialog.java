...
public class SelectJCZQDialog extends Dialog implements OnClickListener {
	...
	private RelativeLayout ll_jczq_dialog;
	// 总进球
	 ...
	 *            0为比分，1为混合
	 */
	private void setWidthAndHeight(int type_height) {
		if (type_height == 0) {
			RelativeLayout.LayoutParams linearParams = (RelativeLayout.LayoutParams) ll_jczq_dialog
					.getLayoutParams();
			linearParams.height = (int) (LotteryUtils
					.getScreenWidthAndHeight(context)[1] * 0.6);
			if (ll_jczq_dialog != null)
				ll_jczq_dialog.setLayoutParams(linearParams);
		} else if (type_height == 1) {
			RelativeLayout.LayoutParams linearParams = (RelativeLayout.LayoutParams) ll_jczq_dialog
					.getLayoutParams();
			linearParams.height = (int) (LotteryUtils
	...
	public void findView() {
		ll_jczq_dialog = (RelativeLayout) findViewById(R.id.ll_jczq_dialog);
	...
	public void setSpfLayoutGone(int gone) {
		layout_rangqiu_notrangqiu.setVisibility(gone);
	}
	 ...
	 * @param visible
	 */
	public void setBifenLayoutGone(int gone) {
		layout_bifen.setVisibility(gone);
	}
	 ...
	 * @param visible
	 */
	public void setZjqLayoutGone(int gone) {
		layout_zjq.setVisibility(gone);
	}
	 ...
	 * @param visible
	 */
	public void setBqcLayoutGone(int gone) {
		layout_bqc.setVisibility(gone);
	}

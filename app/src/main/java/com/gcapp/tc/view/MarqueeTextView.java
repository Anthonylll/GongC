...
public class MarqueeTextView extends TextView {
	...
	public void setRollText(String text, int flag) {
		...
		System.out.println("MarqueeTextView.setText==>mStopMarquee :"
				+ String.valueOf(mStopMarquee));
	...
	protected void onDetachedFromWindow() {
		...
		System.out
				.println("MarqueeTextView.onDetachedFromWindow==>mStopMarquee :"
						+ String.valueOf(mStopMarquee));
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (!TextUtils.isEmpty(mText)) {
			...
			int baseY = (int) (getTop() + mheight / 2

...
public class DtMatchBJDC implements Serializable {
	...
	private String title;// 2015-11-10 周四
	...
	private String sfggwin;
	private String sfgglose;

	public String getSfggwin() {
		return sfggwin;
	}

	public void setSfggwin(String sfggwin) {
		this.sfggwin = sfggwin;
	}

	public String getSfgglose() {
		return sfgglose;
	}

	public void setSfgglose(String sfgglose) {
		this.sfgglose = sfgglose;
	}
	...
	public void setSXDS(boolean isSXDS) {
		this.isSXDS = isSXDS;
	}
	...
	public void setSFGG(boolean isSFGG) {
		this.isSFGG = isSFGG;
	}
	...
	public void setUpdan(String updan) {
		this.updan = updan;
	}
	...
	public void setUpshuang(String upshuang) {
		this.upshuang = upshuang;
	}
	...
	public void setDowndan(String downdan) {
		this.downdan = downdan;
	}
	...
	public void setDownshuang(String downshuang) {
		this.downshuang = downshuang;
	}
	...
	public String toString() {
		return "DtMatch [matchDate=" + matchDate + ", matchDate1=" + matchDate1
				+ ", isNewSPF=" + isNewSPF + ", isZJQ=" + isZJQ + ",isBQC="
				+ isBQC + ", isSXDS=" + isSXDS + ", isCBF=" + isCBF
				+ ", isSFGG=" + isSFGG + "]";
	}
	...
	public String getSfloseball() {
		return sfloseball;
	}

	public void setSfloseball(String sfloseball) {
		this.sfloseball = sfloseball;
	}

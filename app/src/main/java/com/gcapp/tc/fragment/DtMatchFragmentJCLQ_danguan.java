 ...
 * must implement the
 * {@link DtMatchFragmentJCLQ_danguan.OnFatherFragmentInteractionListener}
 * interface to handle interaction events. Use the
 * {@link DtMatchFragmentJCLQ_danguan#newInstance} factory method to create an
 * instance of this fragment.
 */
public class DtMatchFragmentJCLQ_danguan extends Fragment implements
	...
	private List<CJLQMatchItemFragment_danguan> fragments;
	 ...
	 */
	public static DtMatchFragmentJCLQ_danguan newInstance(int playtype,
			int viewPagerCurrentIndex) {
		DtMatchFragmentJCLQ_danguan fragment = new DtMatchFragmentJCLQ_danguan();
	...
	private void findView(View v) {
		fragments = new ArrayList<CJLQMatchItemFragment_danguan>();
	...
	private class MyPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int arg0) {
			CJLQMatchItemFragment_danguan fragment = CJLQMatchItemFragment_danguan
					.newInstance(playtype, NEWTYPE[arg0]);
	...
	public void clearSelect() {
		if (fragments != null) {
			for (int i = 0; i < fragments.size(); i++) {
				CJLQMatchItemFragment_danguan fragment = fragments.get(i);
	...
	public void update(int ways, List<String> indexs, List<String> results) {
		CJLQMatchItemFragment_danguan fragment = fragments.get(ways);

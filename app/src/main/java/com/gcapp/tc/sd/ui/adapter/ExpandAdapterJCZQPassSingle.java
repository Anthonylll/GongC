...
public class ExpandAdapterJCZQPassSingle extends BaseExpandableListAdapter
	...
	private DtMatchFragmentJczq_passSingle fragment;

	/** 组项 **/
	private List<String> mGroups;
	/** 子项 **/
	public static List<List<DtMatch>> list_Matchs;
	private Select_JCZQ_DAN_Activity activity;
	/** 玩法 **/
	...
	public ExpandAdapterJCZQPassSingle(Context context, int passType,
			DtMatchFragmentJczq_passSingle fragment, IphoneTreeView ip) {
		this.context = context;
		activity = (Select_JCZQ_DAN_Activity) context;

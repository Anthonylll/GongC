 ...
 * 
 */
public class SelectPasstype_List_BJDCSFAdapter extends BaseAdapter {
	...
	private SelectPasstype_Gridview_BJDCSFAdapter gvAdapter;

	public SelectPasstype_List_BJDCSFAdapter(Context context, int countDan,
	...
	public View getView(int position, View contentView, ViewGroup arg2) {
		...
		gvAdapter = new SelectPasstype_Gridview_BJDCSFAdapter(context, position);

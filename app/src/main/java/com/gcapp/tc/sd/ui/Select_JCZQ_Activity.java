 ...
 * 
 */
public class Select_JCZQ_Activity extends FragmentActivity implements
		OnClickListener {
	...
	public DtMatchFragmentJczq_passMore fragment;
	/** 单关fragment*/
	public DtMatchFragmentJczq_passSingle singlefragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragment = DtMatchFragmentJczq_passMore.newInstance(this, playtype,
	...
	private void init() {
		...
		playType.put(4, "比分");
		playType.put(5, "半全场");
//		playType.put(6, "胜平负|单");
//		playType.put(7, "让球胜平负|单");
//		playType.put(8, "总进球|单");
//		playType.put(9, "比分|单");
//		playType.put(10, "半全场|单");
		// playType.put(6, "胜平负/让球");
		// playType.put(7, "2选1");
		...
		case 7207:// 胜平负
			index = 2;
			break;
		// 竞彩足球 胜平负/让球、2选1 玩法ID 为 7208、7209.
		// case 7208:// 胜平负/让球
		// index = 6;
		// break;
		// case 7209:// 2选1
	...
	public void onClick(View v) {
		...
		case R.id.btn_help:
			...
			LotteryUtils.backgroundAlpaha(Select_JCZQ_Activity.this, 0.5f);
			break;
		...
		case R.id.iv_up_down:
			...
			popUtil.setOnSelectedListener(new PopupWindowUtil.OnSelectedListener() {
				...
				public void getIndex(int parentIndex, int itemIndex) {
					if (itemIndex <= 10) {
						if (Select_JCZQ_Activity.this.itemIndex != itemIndex) {
							Select_JCZQ_Activity.this.parentIndex = parentIndex;
							Select_JCZQ_Activity.this.itemIndex = itemIndex;
							changePlayType();
						}
					}
					rote(2);// 旋转动画 向下
	...
	private void createPopWindow() {
		LayoutInflater inflact = LayoutInflater.from(Select_JCZQ_Activity.this);
		...
		popWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
			...
			public void onDismiss() {
				LotteryUtils.backgroundAlpaha(Select_JCZQ_Activity.this, 1.0f);
			}
		});
		// 设置popwindow的消失事件
				...
				case KeyEvent.KEYCODE_BACK:
					if (popWindow != null && popWindow.isShowing()) {
						...
						LotteryUtils.backgroundAlpaha(
								Select_JCZQ_Activity.this, 1.0f);
					}
					break;
				}
				return true;
	...
	public void screenDMList() {
		screenPop = new ScreenDtMatchPopupWindow(this, AppTools.list_Matchs,
				layout_main);
...
//			break;
	...
	public void changeFragment() {
		...
		fragmentManager.beginTransaction().replace(R.id.fl_jczq, fragment)
				.commit();
//		if(playtype == 7208 ||playtype == 7209 ||playtype == 7210 ||playtype == 7211 ||
//				playtype == 7212){
//			Log.d("damao","passSingleDMList.size:"+passSingleDMList.size());
//			singlefragment = DtMatchFragmentJczq_passSingle.newInstance(this, playtype,
//					passtype, passMoreDMList, passSingleDMList);
//			fragmentManager.beginTransaction().replace(R.id.fl_jczq, singlefragment)
//					.commit();
//			passtype = 1;
//		}else{
//			fragment = DtMatchFragmentJczq_passMore.newInstance(this, playtype,
...
//		}
	...
	private void playExplain() {
		Intent intent = new Intent(Select_JCZQ_Activity.this,
				PlayDescription.class);
		Select_JCZQ_Activity.this.startActivity(intent);
	}
			...
			dialog.setDialogResultListener(new ConfirmDialog.DialogResultListener() {
				...
				public void getResult(int resultCode) {
					if (1 == resultCode) {// 确定
						...
						Select_JCZQ_Activity.this.finish();

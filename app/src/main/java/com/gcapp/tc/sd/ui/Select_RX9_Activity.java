 ...
 * 
 */
public class Select_RX9_Activity extends Activity implements OnClickListener {
	private final static String TAG = "Select_RX9_Activity";
	/* 头部 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = Select_RX9_Activity.this;
		findView();
		init();
		setListener();
		updateAdapter();
	...
	private void findView() {
		...
		Adapter = new RX9_TeamArrayAdapter(Select_RX9_Activity.this,
				lisTeamArrays,
	 ...
	 */
	public void getItem() {
		Intent intent = Select_RX9_Activity.this.getIntent();
	...
	private void playExplain() {
		Intent intent = new Intent(Select_RX9_Activity.this,
				PlayDescription.class);
		Select_RX9_Activity.this.startActivity(intent);
	}
	...
	private void submitNumber() {
		if (RX9_TeamArrayAdapter.btnMap.size() < 9) {
			Toast.makeText(Select_RX9_Activity.this, "至少选择9场赛事才能投注！",
					Toast.LENGTH_SHORT);
			return;
		}
		Intent intent = new Intent(Select_RX9_Activity.this,
	...
	private void getTeamData() {
		...
		if (lisTeamArrays.size() == 0) {
				...
				public void responseCallback(JSONObject isusesInfo) {
					...
					if (null != isusesInfo) {
						try {
							...
							Adapter = new RX9_TeamArrayAdapter(
									Select_RX9_Activity.this,
									lisTeamArrays,
									VibratorView
			...
			requestUtil.getRx9AndSfcData("75");
		}
	}

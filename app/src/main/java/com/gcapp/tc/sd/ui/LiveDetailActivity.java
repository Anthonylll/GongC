 ...
 * @author anthony
 * @version 5.6.20 
 * @Description 比分直播详细页面
 */
public class LiveDetailActivity extends FragmentActivity implements OnClickListener{

	private Context mContext = LiveDetailActivity.this;
	...
	private LiveIntegral liveIntegral = null;
...
//			String gArea = intent.getStringExtra("gArea");
	...
	private void initViewPager() {
		...
		view_integral = mInflater.inflate(R.layout.live_integral_layout, null);
		...
		public Object instantiateItem(View collection, int position) {
			...
			if ("integral".equals(tag)) {
				if (null == liveIntegral) {
					liveIntegral = new LiveIntegral(mContext, v,matchId,opt);
					liveIntegral.init();
				}
			}
			return v;

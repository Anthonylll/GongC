...
import com.gcapp.tc.sd.ui.Bet_SSQ_Activity;
...
public class MyBetLotteryListAdapter extends BaseAdapter {
	...
	private Bet_SSQ_Activity BetActivity;
	...
	public MyBetLotteryListAdapter(Context context,
		...
		BetActivity = (Bet_SSQ_Activity) context;
	}
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (501 == num.getPlayType())
			...
			holder.tv_type_count_money.setText("胆拖投注  " + num.getCount()
					+ "注  " + listSchemes.get(position).getMoney() + "元");
